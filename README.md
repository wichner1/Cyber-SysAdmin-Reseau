...
Comme mon réseau de base est 10.10.0.0, j'ai structuré cela en utilisant un masque de sous-réseau en /24 (masque 255.255.255.0) pour chaque VLAN. Ce qui me   donne 254 adresses IP utilisables par sous-réseau, ce qui est largement suffisant pour la majorité des départements tout en isolant parfaitement le trafic.
